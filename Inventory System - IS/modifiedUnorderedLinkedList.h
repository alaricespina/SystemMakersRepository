...
// CREDITS TO THE D.S Malik, 
// Author of LinkedList
//***********************************************************
// Author: D.S. Malik
//
...
public:
    ...
    //MODIFICATION IN H_UnorderedLinkedList
    

    Type lookForSmallest() const;
    // Function to look for the smallest item 
    // in the list.
    //
  
    Type lookForBiggest() const;
    // Function to look for the Biggest item 
    // in the list.
    //
};
...
bool unorderedLinkedList<Type>::search(const Type& searchItem) const
{
    ...
    while (current != NULL && !found)    //search the list
        if (current->info.get_name() == searchItem.get_name()) //searchItem is found
            found = true;
        else
...
void unorderedLinkedList<Type>::deleteNode(const Type& deleteItem)
{
    ...
    {
        if (this->first->info.get_name() == deleteItem.get_name()) //Case 2
        {
            current = this->first;
        ...
        else //search the list for the node with the given info
        {
            ...
            {
                if (current->info.get_name() != deleteItem.get_name())
                {
...
template <class Type>
Type unorderedLinkedList<Type>::lookForSmallest() const 
{
...
template <class Type>
Type unorderedLinkedList<Type>::lookForBiggest() const 
{
